//NOTE_201806051859: use pixel shader, not vertex shader.
...
P2F main(V2P pixel)
{
    ...
    float3 local1 = LambertLighting(tangentLightDir, float3(0.000000f, 0.000000f, 1.000000f), MaterialAmbient.rgb, AmbientLight.rgb, LightColor[0].rgb, float4(0.500000f, 0.500000f, 0.770000f, 1.000000f).rgb);
    result.fragment = CombineRGBWithAlpha(local1, float4(0.500000f, 0.500000f, 0.770000f, 1.000000f).a);
    // END GENERATED CODE

    if (result.fragment.a == 0.0f)
        discard;
